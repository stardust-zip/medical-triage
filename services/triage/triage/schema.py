...
class ChatRequest(BaseModel):
    ...
    token (see services/triage/triage/context.py::PatientContext) — a client can no longer
...
class QueueResolvedRequest(BaseModel):
    """Body of POST /internal/triage/queue-resolved (sent by queue-service)."""
